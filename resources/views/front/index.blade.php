                    ...
                    <div class="row gy-4 portfolio-container">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <a href="{{ URL::asset('front/img/portfolio/app-1.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox"><img
                                        src="{{ URL::asset('front/img/portfolio/app-1.jpg') }}" class="img-fluid"
                                        alt=""></a>
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                            <div class="portfolio-wrap">
                                <a href="{{ URL::asset('front/img/portfolio/branding-2.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox"><img
                                        src="{{ URL::asset('front/img/portfolio/branding-2.jpg') }}"
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                            <div class="portfolio-wrap">
                                <a href="{{ URL::asset('front/img/portfolio/branding-3.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox"><img
                                        src="{{ URL::asset('front/img/portfolio/branding-3.jpg') }}"
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <img src="{{ URL::asset('front/img/team/team-1.jpg')}}" class="img-fluid" alt="">
                            <h4>Walter White</h4>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <img src="{{ URL::asset('front/img/team/team-2.jpg')}}" class="img-fluid" alt="">
                            <h4>Sarah Jhinson</h4>
                            <span>Marketing</span>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <img src="{{ URL::asset('front/img/team/team-3.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
                        <div class="member">
                            <img src="{{ URL::asset('front/img/team/team-4.jpg')}}" class="img-fluid" alt="">
                            <h4>Amanda Jepson</h4>
