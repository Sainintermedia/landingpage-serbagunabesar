<section id="hero" class="hero">
    <div class="position-relative container"></div>
    <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-lg-2 order-1">
            <img src="{{ URL::asset('front/img/hero-img.svg') }}" class="img-fluid" alt="" data-aos="zoom-out"
                data-aos-delay="100">
        </div>
    </div>
    </div>

    <div class="icon-boxes position-relative"></div>
