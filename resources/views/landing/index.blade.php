...
<head>
    ...
    <link href="{{ URL::asset('assets/landingpage/css/bootstrap.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ URL::asset('assets/dist/partials/carousel/carousel.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ URL::asset('assets/landingpage/js/bootstrap.bundle.min.js') }}"></script>
